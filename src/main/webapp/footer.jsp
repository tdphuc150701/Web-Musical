								...
								<div class="col-md-3 col-sm-6">
									<div class="aa-footer-widget">
										<div class="aa-footer-widget">
											<h3>Contact Us</h3>
											<address>
												<p>12 Nguyễn Văn Bảo , Gò Vấp HCM</p>
												<p>
													<span class="fa fa-phone"></span>+84-984-218-514
												</p>
												<p>
													<span class="fa fa-envelope"></span>huy182001@gmail.com
												</p>
											</address>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="aa-footer-bottom-area">
							<p>
								Designed by <a href="https://www.facebook.com/vqh182/">Huy</a>
							</p>
