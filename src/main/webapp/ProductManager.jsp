...
<body>
	...
	<div class="container-fluid">
		...
		<a style="margin: 20px 0" class="btn btn-primary"
			href="AddProductForm.jsp">Add Product</a>
		<table class="table">
			...
			<c:forEach var="product" items="${PRODUCTS}">
				...
				<tr>
					...
					<td>${product.getCategories().getCategories_name() }</td>
					<td><img  width="100px" height="100px"
					
					src="img/imgRS/${product.product_image1}"
						alt="polo shirt img"
						onerror="this.onerror=null;this.src='${product.product_image1}';"></td>
